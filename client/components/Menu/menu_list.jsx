...
function menu_list() {
  ...
  return (
    <div className='flex flex-col md:flex-row gap-4 justify-center pt-6'>
      <div className='order-2 md:order-1 w-full p-5 pt-0 md:w-[90%] xl:w-[50%] sm:pl-5 sm:pr-0'>
        ...
        <div className='p-4 pt-6 md:pt-4 w-full justify-center bg-gray-800 rounded-bl-lg rounded-br-lg'>
          {
            data && data.length > 0 ? (
              <ul className='grid grid-cols-2 md:grid-cols-5 sm:grid-cols-5 gap-4 xl:gap-0'>
